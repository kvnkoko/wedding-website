  ...
  const faqs = [
    {
      ...
      answer: 'We recommend semi-formal attire for all events. For the civil signing, business casual is appropriate. For the Mandalay celebration and Yangon reception, we suggest cocktail or semi-formal wear.',
    },
    {
