export default function RSVPPage() {
  return (
    <div className="min-h-screen py-8 sm:py-12 md:py-16 px-4 bg-cream dark:bg-dark-bg flex items-center justify-center transition-colors duration-600 ease-in-out">
